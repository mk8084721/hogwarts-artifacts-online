...
class ArtifactControllerTest {
    ...
    void testFindArtifactByIdSuccess() throws Exception {
        ...
        //When and Then.
        this.mockMvc.perform(get(baseUrl+"/artifacts/1250808601744904191").accept(MediaType.APPLICATION_JSON))
    ...
    void testFindArtifactByIdNotFound() throws Exception {
        ...
        given(artifactService.findById("anyId"))
                .willThrow(new ObjectNotFoundException("artifact","anyId"));

        //When and Then.
        this.mockMvc.perform(get(baseUrl + "/artifacts/anyId").accept(MediaType.APPLICATION_JSON))
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        //When and Then.
        this.mockMvc.perform(put(baseUrl + "/artifacts/678910").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateArtifactErrorIdNotFound() throws Exception {
        ...
        given(artifactService.update(
                eq("678910"),
                Mockito.any(Artifact.class))).willThrow(new ObjectNotFoundException("artifact","678910"));
        //When and Then.
        this.mockMvc.perform(put(baseUrl + "/artifacts/678910").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
    ...
    public void testDeleteArtifactSuccess() throws Exception {
        ...
        this.mockMvc.perform(delete(baseUrl + "/artifacts/678910").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    public void testDeleteArtifactWithNonExistenId() throws Exception {
        //Given
        doThrow(new ObjectNotFoundException("artifact","678910"))
